...
function winAlert(player) {
	...
	if (player == "X") {
	    ...
	    function(data, status){
        		...
        		swal("You Win!!", "Congratulations, you beat the computer! 15 tokens are added to your account!", "success");
	        
	    });
	} else {
		swal("You lost!", "CouponThrills won the game!", "error");
	}
	clearBoard();
}
